...
class LocalTopicDetailRepository implements TopicDetailRepository {
  final Map<String, TopicDetail> _topicDetails = {
    ...
    'net_client_server': const TopicDetail(
    ...
    'net_http_https': const TopicDetail(
      id: 'net_http_https',
      title: 'HTTP e HTTPS',
      description:
    ...
    'data_represent': const TopicDetail(
      id: 'data_represent',
    ...
    'web_building': const TopicDetail(
      id: 'web_building',
    ...
    'build_browser': const TopicDetail(
      id: 'build_browser',
    ...
    'build_framework': const TopicDetail(
      id: 'build_framework',
