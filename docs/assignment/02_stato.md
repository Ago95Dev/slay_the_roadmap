...
- Boot pulito `flutter run -d linux`; `flutter analyze` 0 error; test **83/83**; `flutter build linux --debug` ok.
...
5. UX onboarding: CONTINUE solo a campagna iniziata, chip classe con icona fallback, pulsante menu in Home con rientro (U1-U3).
