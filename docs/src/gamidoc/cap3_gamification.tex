...
al.~\cite{toda}:
\begin{itemize}
\item \textbf{Performance}: punti XP (quiz +100, boss +100), livelli
...
capitolo + avatar persistito; C: una passiva distintiva per boss
(MITM enrage 75\,\%, Amnesiac $-$1 energia, Colossus corazza); D:
