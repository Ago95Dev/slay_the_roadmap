...
\node[cstep, right=of a] (b) {Boss fight\\30 HP vs 50 HP};
...
\begin{itemize}
\item Boss: \textbf{30 HP} (clamp dai valori narrativi 80/120/180/200:
nessun singolo colpo chiude, max 25 di Apocalypse);
giocatore: \textbf{50 HP} da \path{PlayerStats}; \textbf{vite totali 3}.
\item \textbf{Energia 3 per turno} (1 per carta giocata).
\item A fine turno quiz obbligatorio: risposta giusta = \textbf{$-$6
al boss} ($-$10 sulle soglie); risposta errata = danno intero della
mossa boss (8--30, mitigabile con Block).
...
$k$).
\item Quiz da 2--5 domande, soglia \textbf{80\,\%}, tentativi illimitati ma
penalizzati (nessuna XP se non superato).
\item Boss: 30 HP contro 50 HP, energia 3 per turno (1 per carta), 3 vite
totali; quiz-danno a fine turno ($-$6, $-$10 sulle soglie).
